...
# router.register(r'studentapi/(?P<library_id>[0-9]+)',views.StudentViewSet, basename="std")

urlpatterns = [ 
    path('admin/', admin.site.urls),
    path('',include(router.urls)),
    # urls(r'^pay/summary/(?P<sid>\d+)/$', views.getStudentsByStd, name='get_students_by_std'),
]
